...
// ch:��ýڵ�ķ���ģʽ | en:Get Node Access Mode
...
//int CMvCamera::RegisterImageCallBackEx(void * pUser)
//{
//	return MV_CC_RegisterImageCallBackEx(m_hDevHandle, ImageCallBackEx, m_hDevHandle);
//}

void * CMvCamera::outinterface()
{
	return m_hDevHandle;
}
